...
33. [x] Fix Roadmap clipping: Adjust SVG height calculation to accommodate expanded implementation details trays (Plan: P3; Reqs: R4, R11)
34. [x] Fix Roadmap interaction: Robust additive push-down effect using nested SVG groups to support multiple active items (Plan: P3; Reqs: R4, R11)
35. [x] Adjust Roadmap height calculation to prevent clipping when multiple items are expanded (Plan: P3; Reqs: R4, R11)
