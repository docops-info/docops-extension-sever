...
* *b14091d* - Add `SkillsController` to enable skill-based ZIP file downloads ([b14091d](https://github.com/docops-info/docops-extension-server/commit/b14091db)).

=== Changed

* *ea9f643* - Refactor `ModernPlannerMaker` to use `ThemeFactory` for dynamic theme handling ([ea9f643](https://github.com/docops-info/docops-extension-server/commit/ea9f6435)).
* *426e2a3* - Refactor `SkillsController` to use `PathMatchingResourcePatternResolver` for improved resource handling ([426e2a3](https://github.com/docops-info/docops-extension-server/commit/426e2a3e)).
* *5ba3f80*, *84f3383* - Cleanup and maintenance.

=== Notes
* Version bump: patch (refactoring and minor feature additions).
