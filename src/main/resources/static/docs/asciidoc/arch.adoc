...
:prev-page-title: ADR
:prev-page-url: adr.html
:next-page-title: Buttons
:next-page-url: buttons.html
...
[plantuml, comp,format=svg, role="popup-diagram"]
----

!include plantuml/themes/puml-theme-docops.puml
...
[plantuml,badge,format=svg, role="popup-diagram"]
----
!include plantuml/themes/puml-theme-docops.puml
...
link:plantuml/showcase.html[DocOps PlantUML Themes]
