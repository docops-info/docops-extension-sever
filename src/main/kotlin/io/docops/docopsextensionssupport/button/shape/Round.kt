...
class Round(buttons: Buttons) : Regular(buttons) {
    ...
    override fun drawButton(index: Int, buttonList: MutableList<Button>): String {
        ...
        <a xlink:href="${button.link}" target="$win">
            <use x="0" y="0" xlink:href="#myCircle" class="raise btn_${button.id}_cls" fill="${button.color}" stroke-width="2" stroke="$strokeColor" stroke-dasharray="2000" stroke-dashoffset="2000">
