...
@Serializable
class BarDisplay(val id: String = UUID.randomUUID().toString(), val baseColor: String = "#FE7A36", val type: String = "R", val vBar : Boolean = false, val sorted: Boolean=false, val theme: String = "modern_editorial", val scale: Float = 1.0f,  override var useDark: Boolean = false,
