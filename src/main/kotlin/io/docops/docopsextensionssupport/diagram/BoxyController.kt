...
class BoxyController {
    ...
    fun makeDiag(httpServletRequest: HttpServletRequest): ResponseEntity<ByteArray> {
        val timings = measureTimedValue {
            ...
            val imageUrl = "https://roach.gy/extension/api/docops/svg?kind=connector&payload=${compressedPayload}&type=SVG&useDark=false&title=Title&numChars=24&backend=html5&filename=connector.svg"
