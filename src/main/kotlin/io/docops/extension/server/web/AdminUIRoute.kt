...
fun Route.adminUI() {
   ...
   <tspan x="50%" y="551" font-family="Rubik Mono One" font-size="90" fill="$fontColor" letter-spacing="2.56"
    ...
    <tspan x="50%" y="651" font-family="Rubik Mono One" font-size="90" fill="$fontColor" letter-spacing="2.56"
        ...
        """.trimIndent())
            val contents = makePanelImage(fillColor,fontColor,line1,line2, line3)
...
fun makePanelImage(fillColor: String, fontColor: String, line1: String, line2: String?, line3: String?) : String
{
    val span1 = """<tspan text-anchor="middle" x="50%" y="499" font-family="Helvetica Neue" font-size="72" font-stretch="condensed" font-weight="700" fill="$fontColor" xml:space="preserve">$line1</tspan>"""
    var span2 = ""
    line2?.let {
        span2 = """<tspan text-anchor="middle" x="50%" y="569.015991" font-family="Helvetica Neue" font-size="72" font-stretch="condensed"
