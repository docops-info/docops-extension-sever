...
==== Rectangle Bars, type=R

[docops,bar,controls=false]
----
include::data/sales.txt[]
----

==== Cylindrical Bars, type=C

[docops,bar,controls=false,role=secondary]
----
include::data/salesc.txt[]
----
...
[docops,bar,controls=true]
----
include::data/monthly.txt[Monthly Data]
----
....
