...
= image:icons/VCardIcon.svg[Wordcloud Icon,36,36] 👤 DocOps VCard Maker
...
TEL;TYPE=WORK:+1-555-0456
TEL;TYPE=CELL:+1-555-0457
EMAIL:sroach@travelers.com
URL:https://roach.gy/steve
NOTE:Architecting solutions to meet business needs.
END:VCARD
----
...
|premium
|Apple-inspired, clean, and typographic-first (default)
