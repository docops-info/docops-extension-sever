...
.Hexagonal Buttons - Dark Mode
[docops,buttons,useDark=true,controls=true]
----
include::data/buttons/buttons3b.json[]
----
...
.Rectangular Buttons with Dark Mode
