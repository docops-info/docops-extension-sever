...
subtitle=Steps to get to create documents
canvasWidth=1220
canvasHeight=760
theme=tokyo
palette=vibrant
---
Order | Title | Description | Color
3 | Forms | Get List of forms | #6EAEFF
1 | Quote | Get quote data | #6EAEFF
2 | Policy | Get Policy Data | #6EAEFF
4 | Reference | Get Reference Data | #69DEE5
5 | Preference | Get Delivery Preferences | #69DEE5
6 | Toggle | Get Feature Toggle | #69DEE5
7 | Content | Get Content from CMS | #69DEE5
8 | Package | Build Package for DC2 | #6EAEFF
9 | Deliver | Deliver Document | #6EAEFF
----
...
subtitle=Rules & Configuration
canvasWidth=1220
canvasHeight=760
---
Order | Title | Description
1 | Versioning | Capability by Version
2 | Open Feature | Feature Toggles
3 | Decision | Decision Table
4 | Sapiens | Light weight Rules Engine
----
[.back-to-top]
<<top, 🔝>>
...
|view
|`isometric`
|View style: `isometric` (default 3D blocks) or `road` (winding road layout)
