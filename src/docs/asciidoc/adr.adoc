...
This example demonstrates how to format participants on multiple lines for better readability:
...
participants:
Rebecca Chen (Data Architect)
Mark Johnson (Data Engineer)
Priya Patel (Business Intelligence Lead)
Thomas Garcia (Cloud Infrastructure Specialist)
Sarah Kim (Data Governance Officer)
----
....
