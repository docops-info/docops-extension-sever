...
Author diagrams directly in AsciiDoc using a compact CSV-like syntax inside a DocOps block. The server parses your payload and returns an SVG.
...
BACKEND,🧑🏻‍💻,1,"BACKEND,KOTLIN,JAVA,.NET,PYTHON,GO,RUST"
----
....
