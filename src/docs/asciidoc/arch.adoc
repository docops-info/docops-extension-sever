...
title DocOps Extension Server Architecture  <color:#8E8E93><size:13>Modern Visualization Platform for AsciiDoctor</size></color>

' External Systems
node "AsciiDoctor Document" as asciidoc #FFEBEE {
    component "[docops,kind] Block Processor" as macro #FFCDD2
}
