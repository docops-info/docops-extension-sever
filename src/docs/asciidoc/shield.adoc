...
To include shields in your AsciiDoctor document, you use a special macro syntax. Here's the basic format:
...
The DocOps Shield Extension provides a powerful way to enhance your AsciiDoctor documents with visually appealing badges and shields. By using the pipe-delimited configuration format, you can create customized shields that match your document's style and purpose.
