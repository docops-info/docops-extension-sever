...
category.core=Core API|#0891b2
category.business=Business Logic|#059669
category.technology=Technology Enhancement|#7c3aed
category.ai=AI/ML Integration|#dc2626
category.infrastructure=Infrastructure|#ea580c
category.lifecycle=API Lifecycle|#f59e0b
